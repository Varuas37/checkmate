    ...
    <div className="mx-auto flex w-full max-w-[1200px] flex-col gap-4 px-1">
      <section className="border-b border-border/60 pb-4">
        ...
        {aiAnalysisStatus === "error" && (
          <div className="mt-3 flex items-center gap-1.5 text-danger">
            <p className="text-xs">AI summary generation failed. Reload the commit or run AI analysis again.</p>
            <Button
              size="sm"
              variant="ghost"
              ...
              title="Retry AI summary generation"
            >
              <AiRetryIcon />
              Retry
            </Button>
